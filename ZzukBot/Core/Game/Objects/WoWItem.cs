...
namespace ZzukBot.Core.Game.Objects
{
    ...
    public class WoWItem : WoWObject
    {
        ...
        /// </summary>
        public Enums.ItemClass Class => Memory.Reader.Read<Enums.ItemClass>(IntPtr.Add(ItemCachePointer, Offsets.Item.ItemCachePtrClass));

        /// <summary>
        /// The subclass of an item
        /// </summary>
        public Enums.ItemSubclass Subclass => Memory.Reader.Read<Enums.ItemSubclass>(IntPtr.Add(ItemCachePointer, Offsets.Item.ItemCacheSubclass));
