...
namespace ZzukBot.Core.Game.Objects
{
    ...
    public class WoWUnit : WoWObject
    {
        ...
        /// <summary>
        /// An enumerable of nearby players
        /// </summary>
        public IEnumerable<WoWUnit> NearbyPlayers => ObjectManager.Instance.Units.Where(x => x.IsPlayer);
        ...
        /// <summary>
        ///     Determines if the unit is Horde
        /// </summary>
        ...
        /// <summary>
        ///     Determines if the unit is Neutral
        /// </summary>
        ...
        public List<int> Debuffs
        {
            ...
            {
                var tmpAuras = new List<int>();
                var auraBase = Offsets.Unit.DebuffBase;
                var curCount = 0;
                while (true)
                {
                    var auraId = GetDescriptor<int>(auraBase);
        ...
        /// <summary>
        ///     Determines if the unit is a vendor
        /// </summary>
        public bool IsVendor => (NpcFlags & Enums.NpcFlags.UNIT_NPC_FLAG_VENDOR) != 0;

        /// <summary>
        ///     Determines if the unit can repair
        /// </summary>
        public bool IsRepair => (NpcFlags & Enums.NpcFlags.UNIT_NPC_FLAG_REPAIR) != 0;
        ...
        /// </summary>
        public virtual int CastingId => ReadRelative<int>(0xC8C);

        /// <summary>
        /// Determines if a unit is casting a spell
        /// </summary>
        ...
        /// </summary>
        public int ChannelingId => GetDescriptor<int>(Offsets.Descriptors.IsChanneling);

        /// <summary>
        /// Determines if a unit is channeling a spell
        /// </summary>
        ...
        /// </summary>
        public Enums.CreatureFamily CreatureFamily => Functions.GetCreatureFamily(Pointer);
