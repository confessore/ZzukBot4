...
namespace ZzukBot.Core.Game.Objects
{
    /// <summary>
    ...
    public class LocalPlayer : WoWUnit
    {
        ...
        /// </summary>
        public int AttackPower => Lua.Instance.PlayerAttackPower;
        ...
        ///     The casting.
        /// </value>
        public override int CastingId
        {
            get
            {
                var tmpId = base.CastingId;
        ...
        /// </value>
        public string CastingAsName => Spell.Instance.GetName(CastingId);
        ...
        /// <summary>
        ///     Determines if the player is Horde
        /// </summary>
        public new bool IsAlliance
        {
            get
            {
                var tmp = new List<int>();
                foreach (int item in Enum.GetValues(typeof(Enums.FactionPlayerAlliance)))
                    tmp.Add(item);
                return tmp.Contains(FactionId);
            }
        }
        ...
        ///     Determines if the player is Horde
        /// </summary>
        public new bool IsHorde
        {
            get
            {
                var tmp = new List<int>();
                foreach (int item in Enum.GetValues(typeof(Enums.FactionPlayerHorde)))
                    tmp.Add(item);
                return tmp.Contains(FactionId);
            }
        }
        ...
        /// </summary>
        /// <returns>
        ///     Returns <c>true</c> if the mainhand is enchanted or if the mainhand does not exist
        /// </returns>
        public bool IsMainhandEnchanted()
        {
            try
            {
                if (Inventory.Instance.GetEquippedItem(Enums.EquipSlot.MainHand) == null)
                    return true;
        ...
        /// </summary>
        /// <returns>
        ///     Returns <c>true</c> if the offhand is enchanted or if the offhand does not exist
        /// </returns>
        public bool IsOffhandEnchanted()
        {
            try
            {
                if (Inventory.Instance.GetEquippedItem(Enums.EquipSlot.OffHand) == null)
                    return true;
        ...
        /// </returns>
        public new bool IsAoeSafe(int parRange)
        {
        ...
        {
            var totem = ObjectManager.Instance.Npcs.FirstOrDefault(i => i.Name.ToLower().Contains(parName.ToLower())
                                                                            &&
                                                                            i.SummonedBy ==
