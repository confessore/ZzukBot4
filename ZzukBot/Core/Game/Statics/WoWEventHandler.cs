...
namespace ZzukBot.Core.Game.Statics
{
    ...
    public sealed class WoWEventHandler
    {
        ...
        public class OnLootArgs : EventArgs
        {
            ...
            /// <summary>
            /// The time that the item was looted?
            /// </summary>
            public DateTime Time { get; }

            /// <summary>
            /// Log of the looted item
            /// </summary>
            /// <returns></returns>
        ...
        {
            /// <summary>
            ///     The unit with the changed aura
            /// </summary>
        ...
        {
            /// <summary>
            ///     The player that requested a trade?
            /// </summary>
        ...
        public class ChatMessageArgs : EventArgs
        {
            ...
            /// <summary>
            /// The type of unit that sent the message
            /// </summary>
            public Enums.ChatSenderType UnitType { get; private set; }
            /// <summary>
            /// The tag of the chat message
            /// </summary>
            public string ChatTag { get; }
            /// <summary>
            /// The name of the unit that sent the message
            /// </summary>
            public string UnitName { get; }
            /// <summary>
            /// The channel that the message appeared in
            /// </summary>
            ...
            /// <summary>
            /// The time that the chat message appeared
            /// </summary>
            public DateTime Time { get; }
