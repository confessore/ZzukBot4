...
namespace ZzukBot.Core.Constants
{
    internal static class PrivateEnums
    {
        ...
        {
            private static readonly string elysium = "elysium";
            private static readonly string lightshope = "lightshope";
            private static readonly string symmetry = "symmetry";
            ...
            internal static int IsMarked
            {
                get
                {
                    if (Default.Realmlist.Contains(elysium) || Default.Realmlist.Contains(lightshope) || Default.Realmlist.Contains(symmetry))
                        return 0x2;
                    return 0x2;
                }
            }
