...
namespace ZzukBot.Core.Mem
{
    internal static class Memory
    {
        ...
        [DllImport("AntiQuery.dll", CallingConvention = CallingConvention.Cdecl)]
        ...
        internal static void Init()
        {
            ...
            /*var DisableCollision1 = new Hack(Offsets.Hacks.DisableCollision1,
                new byte[] { 0x0F, 0x85, 0x1B, 0x01, 0x00, 0x00 },
                "DisableCollision1");
            HookWardenMemScan.AddHack(DisableCollision1);*/
            //DisableCollision1.Apply();
            // Ctm Patch
            ...
            /*var DisableCollision3 = new Hack(Offsets.Hacks.DisableCollision3, new byte[] { 0xEB, 0x69 }, "DisableCollision3"); // new byte[] { 0xEB, 0x69 }
            HookWardenMemScan.AddHack(DisableCollision3);
            DisableCollision3.Apply();*/
