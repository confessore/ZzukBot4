...
using ZzukBot.GUI.Utilities.Commands.Interfaces;
using ZzukBot.GUI.Utilities.Extensions;

namespace ZzukBot.GUI.Utilities.Commands
{
    internal class CommandHandler : IDisposable
    {
        private static readonly Dictionary<object, CommandHandler> Instances = new Dictionary<object, CommandHandler>();
